...
// needsPostprocessing reports whether the datums written by an upload request change the data
// platform postprocesses. Upload records describe a data set and carry no data of their own, and
// the legacy uploader posts one alone before the batches of the data it describes.
function needsPostprocessing(written) {
  return written.some(datum => datum.type !== 'upload');
}
