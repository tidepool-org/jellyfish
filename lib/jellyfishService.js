  ...
  var serviceManager = {
    ...
    startService: function (app, servicePort, cb) {
      ...
      if (envConfig.httpPort != null) {
        ...
        this.theServer = https.createServer(envConfig.httpsConfig).listen(servicePort, cb);
      }
    }
  };
...
function createServer(serverConfig, mongoClient, seagullClient, userApiClient, gatekeeperClient){
  ...
  var carelinkUploadFlow = require('./carelinkUploadFlow.js')({ storageDir: serverConfig.tempStorage }, tasks);
