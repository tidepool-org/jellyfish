...
var datumConfig = require('./schema/datumEnv.js');
...
module.exports = function(mongoClient){
  ...
  return {
    ...
    insertDatum: function(datum, cb) {
      ...
      datum._version = 0;
      datum._active = true;
      //NOTE: at this moment all datum's have a _schemaVersion set the same but over time it could (will) be
      //updated on a per type basis. This would likely happen in eachs individual types schema file in the ./schema directory
