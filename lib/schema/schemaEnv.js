...
function usePlatform(userId) {
  ...
  const salt = config.fromEnvironment('USER_ID_SALT', null);
  const platformUsers = misc.loadHashedPlatformUserId(environment);
  return platformUsers.includes(misc.hashUserId(userId, salt))
}
...
module.exports = (function () {
  ...
  schemaEnv.isPlatformUserId = usePlatform;
