...
schema.registerFieldsForPlatformDuplicator('pumpSettings');
...
module.exports = schema.makeHandler('pumpSettings', {
  schema: {
    ...
    automatedDelivery: schema.ifExists(schema.in(true, false)),
    firmwareVersion: schema.ifExists(schema.isString)
  },
