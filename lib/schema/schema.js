...
exports.convertMgToMmolPrecision = function(mg) {
  const mmolLToMgdLConversionFactor = 18.01559;
  const mmolLToMgdLPrecisionFactor = 100000.0;
  let mmolVal = Math.round(mg / mmolLToMgdLConversionFactor * mmolLToMgdLPrecisionFactor + 0.5);
...
var fields = Array.prototype.slice.call(arguments, 1);
  ...
  for (var i = 0; i < fields.length; ++i) {
    ...
    if (normalUnits === 'mg/dL' && datum[field] != null) {
      datum[field] = exports.convertMgToMmolPrecision(datum[field]);
    }
  }
