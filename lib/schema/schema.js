...
exports.postConversionCleanup = function(datum) {
  //remove the un-needed originUnits as we have finished conversions
  delete datum.originUnits;
  //set the units to be the universal `units: mmol/L`
  datum.units = 'mmol/L';
...
exports.convertUnits = function(datum) {
  ...
  for (var i = 0; i < fields.length; ++i) {
    var field = fields[i];
    var normalUnits = exports.normalizeUnitName(datum.originUnits);
    if (normalUnits != null) {
      datum.originUnits = normalUnits;
    }

    if (datum.originUnits === 'mg/dL' && datum[field] != null) {
