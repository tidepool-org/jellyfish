...
var jsonSchemas = require('./jsonSchemaHandling.js')
...
**
**/
exports.isJsonSchemaValiatedObject = function(jsonSchema) {
  return function(val) {
    var errors = jsonSchemas.validate(val, jsonSchema);
    if (errors.length > 0) {
      throw except.IAE('Object does not match %s schema: %s', jsonSchema, errors[0].desc);
...
var baseChecks = {
  ...
  _schemaVersion: exports.doesNotExist
};
