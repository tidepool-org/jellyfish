...
exports.in = function() {
  ...
  for (var i = 0; i < arguments.length; ++i) {
    if (Array.isArray(arguments[i])) {
      arguments[i].forEach(function(key) {
...
exports.generateId = function(datum, fields) {
  ...
  for (var i = 0; i < fields.length; ++i) {
    var val = datum[fields[i]];
    if (val == null) {
      throw except.IAE('field[%s] didn\'t exist on datum of type[%s]', fields[i], datum.type);
    }
...
exports.attachIds = function(data, fields) {
  ...
  for (var i = 0; i < data.length; ++i) {
    ...
    if (datum._id == null) {
      datum._id = exports.generateId(datum, ['id', '_groupId']);
    }
  }
