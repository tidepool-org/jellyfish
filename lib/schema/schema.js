...
exports.generateId = function(datum, fields) {
  ...
  if (datum.type == 'smbg') {
    log.info('smbg vals ', JSON.stringify(vals));
    log.info('smbg vals ', JSON.stringify(datum));
    log.info('smbg ID ', misc.generateId(vals));

    console.log('smbg vals: ', JSON.stringify(vals));
    console.log('smbg datum: ', JSON.stringify(datum));
    console.log('smbg ID : ', misc.generateId(vals));
  }
