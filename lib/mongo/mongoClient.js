...
module.exports = function(config){
  ...
  return {
    ...
    withCollection: function(collectionName, clientCb, collCb) {
      ...
      mongoClient.db(databaseName).collection(collectionName, function(err, collection) {        if (err != null) {
          clientCb(err);
        }
    ...
    start: function(cb){
      ...
      var connectionURI = new URL(config.connectionString);
      databaseName = connectionURI.pathname.replace('/','') || 'data';
