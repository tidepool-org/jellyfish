...
module.exports = function (config) {
  ...
  return {
     ...
     * `close()` times.
     *
     * @param collectionName String name of the mongo collection to get
    ...
    /**
     * This is equivalent to the Node.js mongodb driver's WithTransactionCallback. It is an asynchronous function that is ran in a transacation and must use the supplied session in all its operations.
     * @async
