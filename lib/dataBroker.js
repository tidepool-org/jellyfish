...
module.exports = function(streamDAO) {
  ...
  return {
    addData: function(dataOrDatum, updatedSummary, cb) {
      ...
      // The checks in the above code have made sure each datum has the same type
      // as firstDatum.type so using the handler at schemas[firstDatum.type] is safe
      // and valid for all data.
